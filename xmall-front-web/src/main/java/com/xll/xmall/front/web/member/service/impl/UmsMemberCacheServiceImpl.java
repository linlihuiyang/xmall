package com.xll.xmall.front.web.member.service.impl;


import com.xll.xmall.common.annotation.CacheException;
import com.xll.xmall.common.service.RedisService;
import com.xll.xmall.front.web.member.service.UmsMemberCacheService;
...
//    }
    ...
    @Override
    public UmsMemberBO getMember(String username) {
        String key = REDIS_DATABASE + ":" + REDIS_KEY_MEMBER + ":" + username;
        return (UmsMemberBO) redisService.get(key);
    }

    @Override
    public void setMember(UmsMemberBO member) {
